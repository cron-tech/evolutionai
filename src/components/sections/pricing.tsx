        ...
        {plans.map((plan, index) => (
          <Reveal key={plan.id} index={index}>
            <div
              ...
              className={cn(
                "relative flex h-full flex-col gap-6 rounded-2xl bg-background p-6 text-left shadow-[0_8px_24px_-8px_rgb(0_0_0_/_0.15)] transition-[transform,box-shadow] duration-[var(--duration-hover)] ease-[var(--ease-hover)]",
                "hover:-translate-y-1 hover:shadow-[0_16px_40px_-12px_rgb(0_0_0_/_0.25)]",
                "focus-within:-translate-y-1 focus-within:shadow-[0_16px_40px_-12px_rgb(0_0_0_/_0.25)]",
